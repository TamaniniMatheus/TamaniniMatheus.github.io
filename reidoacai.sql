...
CREATE TABLE PEDIDO(
    ...
    STATUS_PED VARCHAR(20) NOT NULL DEFAULT 'Recebido',
...
CREATE TABLE ITEM_PEDIDO(
    ...
    COD_ADC INT NULL,
    FOREIGN KEY (COD_PED) REFERENCES PEDIDO(ID_PED) ON DELETE CASCADE,
...
ALTER TABLE CLIENTE ADD CONSTRAINT uq_email UNIQUE (EMAIL_CLI);
ALTER TABLE CLIENTE ADD CONSTRAINT uq_usuario UNIQUE (USUARIO);
ALTER TABLE CLIENTE ADD CONSTRAINT uq_cpf UNIQUE (CPF_CLI);
